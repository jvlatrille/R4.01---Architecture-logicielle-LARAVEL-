            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            <label for="carteBancaire" class="col-md-4 col-form-label text-md-end">{{ __('Carte Bancaire') }}</label>

                            <div class="col-md-6">
                                <input id="carteBancaire" type="text" class="form-control @error('carteBancaire') is-invalid @enderror" name="carteBancaire" value="{{ old('carteBancaire') }}" required autocomplete="carteBancaire">
